...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp text-brand-900 shadow-lift transition-all duration-300 hover:bg-whatsapp-dark hover:scale-105 sm:h-16 sm:w-16 ${
