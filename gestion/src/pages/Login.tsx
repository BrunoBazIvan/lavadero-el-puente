      ...
      <div className="flex flex-1 items-center justify-center px-4 py-10">
        <div className="w-full max-w-sm">
          <div className="mb-7 text-center">
            ...
            <p className="mt-1 font-display text-xs uppercase tracking-technical text-aqua-300">
...
function FormularioIngreso({ onOlvide }: { onOlvide: () => void }) {
  ...
  return (
    <form onSubmit={enviar} noValidate>
      <h1 className="mb-5 font-display text-lg font-bold text-brand-900">Entrar</h1>
...
function FormularioRecordar({ onVolver }: { onVolver: () => void }) {
  ...
  if (enviado) {
    return (
      <div>
        <h1 className="mb-3 font-display text-lg font-bold text-brand-900">Revisá tu correo</h1>
  ...
  return (
    <form onSubmit={enviar} noValidate>
      <h1 className="mb-2 font-display text-lg font-bold text-brand-900">Recuperar contraseña</h1>
